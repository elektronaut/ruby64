...
describe Ruby64::Cartridge do
  let(:address_bus) { Ruby64::AddressBus.new }

  def chip(bank:, address:, data:)
    Ruby64::Storage::CRTFile::Chip.new(chip_type: 0, bank:, address:, data:)
  end

  def crt(hardware_type:, exrom:, game:, chips:)
    instance_double(Ruby64::Storage::CRTFile, hardware_type:, exrom:, game:, name: "TEST", chips:)
  end
  ...
  describe "an Ultimax cartridge" do
    ...
    it "exposes ROMH to the VIC at $3000-$3FFF" do
      bank = Ruby64::VIC::Bank.new(address_bus)
